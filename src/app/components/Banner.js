      ...
      <div className="container mx-auto min-h-[768px] flex items-center justify-center">
        ...
        >
          <MouseParallaxChild factorX={0.1} factorY={0.2}>
            <div className="flex flex-col lg:flex-row items-center text-center lg:text-left flex-z px-6 text-white">
              <div className="flex-1">
                <p className="font-bangers text-[32px] text-white uppercase tracking-[0.03em]">
                  Best Pizza in town
                </p>
                <h1 className="text-6xl lg:text:text-8xl font-bangers drop-shadow-md">
